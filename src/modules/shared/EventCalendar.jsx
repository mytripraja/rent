...
export default function EventCalendar() {
  const { user } = useAuth()
  // 'admin' is the super-admin's role and 'owner' is a co-owner's — both are
  // owner-level accounts with identical day-to-day access (see firestore.rules'
  // isOwner() helper, which treats them the same way).
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-semibold text-ink">Community Events</h3>
        {isOwner && (
