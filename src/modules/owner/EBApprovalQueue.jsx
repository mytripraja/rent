...
export default function EBApprovalQueue() {
  ...
  if (pending.length === 0) {
    return <p className="text-sm text-slate-400 py-8 text-center">No EB bill submissions waiting for approval.</p>
  }

  return (
    <div className="space-y-3">
      <h2 className="text-lg font-semibold text-slate-800">EB Bill — Pending Approvals</h2>
      {pending.map((p) => (
